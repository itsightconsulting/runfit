...
! function(a) {
    ...
    b.prototype = {
        ...
        "mousedown": function(b) {
            ...
            setTimeout(()=>{$('#PorcentajesKilometraje label.perc[data-index=\"'+ $initIndex+'\"]').text(100-c+'%');$('#PorcentajesKilometraje label.kms[data-index=\"'+ $initIndex+'\"]').text(($initKms*(100-c)/100).toFixed(1));}, 100)
        ...
        "mousemove": function(a) {
            ...
            $('#PorcentajesKilometraje label.perc[data-index=\"'+ $initIndex+'\"]').text(100-c+'%');
            $('#PorcentajesKilometraje label.kms[data-index=\"'+ $initIndex+'\"]').text(($initKms*(100-c)/100).toFixed(1));
            return this.element.trigger({
                "type": "slide",
                "value": c
