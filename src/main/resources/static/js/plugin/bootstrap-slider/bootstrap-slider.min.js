    ...
    b.prototype = {
        ...
        "mousedown": function(b) {
            ...
            if ($slideType == 1) {
                ...
                cv = f;
                const nKms = ($initKms * (cv) / 100);
                $('#collapseDetallados label.porcentaje-metrica[data-index=\"' + $initIndex + '\"]').text(nKms.toFixed(1));
            }
            else {
        ...
        "mousemove": function(a) {
            ...
            if ($slideType == 1) {
                ...
                $('#collapseDetallados label.porcentaje-metrica[data-index=\"' + $initIndex + '\"]').text(strTotal.toFixed(1));
            }
            else {
                $('#PorcentajesIntensidad label.perc-ints[data-index=\"' + $initIndex + '\"]').text(cv + '%')
                $chartTemporada.data.datasets[1].data[$initIndex - 1] = cv
