    ...
    b.prototype = {
        ...
        "mousedown": function(b) {
            if(b.target.classList.contains('slider-selection') || b.target.classList.contains('slider-handle'))
                $yelmo = b.target.parentElement.previousElementSibling.getAttribute('data-index');
            if(b.target.classList.contains('slider-track'))
                $yelmo = b.target.previousElementSibling.getAttribute('data-index');
            setTimeout(()=>{$('#PorcentajesKilometraje label.perc[data-index=\"'+ $yelmo+'\"]').text(100-c+'%');$('#PorcentajesKilometraje label.kms[data-index=\"'+ $yelmo+'\"]').text(60*(100-c)/100);}, 100)
        ...
        "mousemove": function(a) {
            ...
            $('#PorcentajesKilometraje label.perc[data-index=\"'+ $yelmo+'\"]').text(100-c+'%');
            $('#PorcentajesKilometraje label.kms[data-index=\"'+ $yelmo+'\"]').text(60*(100-c)/100);
            return this.element.trigger({
                "type": "slide",
                "value": c
