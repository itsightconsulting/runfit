    ...
    b.prototype = {
        ...
        "mousedown": function(b) {
            ...
            if ($slideType == 1) {
                ...
                Array.from(document.querySelector('#MetricasDetalladas .detallados-velocidades').firstElementChild.querySelectorAll('.col-md-11')).slice(0,-1).forEach((v,i)=>{
                    const met = v.querySelector('.dt-ix'+$initIndex);
                    const ref = JSON.parse($ruConsolidado.matrizMejoraVelocidades)[$initIndex - 1].ind[i].toSeconds();
                    const n = ref+(c-50);
                    n > 0 ? met.textContent = String(n).toHHMMSSM() : "";
                });
            }
            else {
