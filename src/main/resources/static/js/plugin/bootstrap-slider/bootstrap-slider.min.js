    ...
    b.prototype = {
        ...
        "mousedown": function(b) {
            ...
            if ($slideType == 1) {
                ...
                cv = f;
                const nKms = ($initKms * (cv) / 100);
                $('#PorcentajesMetricas label.porcentaje-metrica').text(nKms.toFixed(1));
                let segundostotal = secondsToHms(totalsegundos * nKms /100);
                $('#TiempoControl').val(segundostotal);
            }
            else {
        ...
        "mousemove": function(a) {
            ...
            if ($slideType == 1) {
                ...
                cv = c;
                var strTotal = ($initKms * (cv) / 100);
                $('#PorcentajesMetricas label.porcentaje-metrica').text(strTotal.toFixed(1));

                let segundostotal = secondsToHms(totalsegundos * strTotal /100);
                $('#TiempoControl').val(segundostotal);
            }
            else {
                $('#PorcentajesIntensidad label.perc-ints[data-index=\"' + $initIndex + '\"]').text(cv + '%')
