...
const ClaseEditor = Object.freeze([
    ...
    {id: 216, clase: 'rf-ff-montserrat', tipo: 1},
    {id: 217, clase: 'rf-ff-arial', tipo: 1},
    {id: 218, clase: 'rf-ff-helvetica', tipo: 1},
    {id: 219, clase: 'rf-ff-timesnewsroman', tipo: 1},
    {id: 220, clase: 'rf-ff-georgia', tipo: 1},
    {id: 221, clase: 'rf-ff-bookman', tipo: 1},
    {id: 222, clase: 'rf-ff-impact', tipo: 1},
...
const exceptNames = {
    ...
    "-10": "EX_NULL_POINTER",
    "-99": "EX_NUMBER_FORMAT",
    "-100": "EX_MAX_SIZE_MULTIPART",
    "-101": "EX_MAX_UPLOAD_SIZE"
};
const meses = ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];
const _idiomas = [{cd: "es", nombre: "Español"}, {cd: "en", nombre: "Inglés"}, {
    cd: "pt",
    nombre: "Portugués"
}, {cd: "de", nombre: "Alemán"}, {cd: "ar", nombre: "Árabe"}, {cd: "bn", nombre: "Bengalí"}, {
    cd: "zh",
    nombre: "Chino"
}, {cd: "ko", nombre: "Coreano"}, {cd: "fr", nombre: "Francés"}, {cd: "hi", nombre: "Hindi"}, {
    cd: "it",
    nombre: "Italiano"
}, {cd: "ja", nombre: "Japonés"}, {cd: "ru", nombre: "Ruso"}];
const _niveles = [{cd: 'pr', nombre: 'Principiante'}, {cd: 'in', nombre: 'Intermedio'}, {
    cd: 'av',
    nombre: 'Avanzado'
}, {cd: 'pf', nombre: 'Profesional'}];
const _forsTrabajo = [{cd: 'ai', nombre: 'Al aire libre'}, {cd: 'pe', nombre: 'Personalizado'}, {
    cd: 'eg',
    nombre: 'En grupo'
}, {cd: 'on', nombre: 'Online'}];
const _ubigeoPeLi = [{ub: "150101", nom: "Lima"}, {ub: "150102", nom: "Ancon"}, {
    ub: "150103",
    nom: "Ate"
}, {ub: "150104", nom: "Barranco"}, {ub: "150105", nom: "Breña"}, {ub: "150106", nom: "Carabayllo"}, {
    ub: "150107",
    nom: "Chaclacayo"
}, {ub: "150108", nom: "Chorrillos"}, {ub: "150109", nom: "Cieneguilla"}, {ub: "150110", nom: "Comas"}, {
    ub: "150111",
    nom: "El Agustino"
}, {ub: "150112", nom: "Independencia"}, {ub: "150113", nom: "Jesus Maria"}, {
    ub: "150114",
    nom: "La Molina"
}, {ub: "150115", nom: "La Victoria"}, {ub: "150116", nom: "Lince"}, {ub: "150117", nom: "Los Olivos"}, {
    ub: "150118",
    nom: "Lurigancho"
}, {ub: "150119", nom: "Lurin"}, {ub: "150120", nom: "Magdalena del Mar"}, {
    ub: "150121",
    nom: "Pueblo Libre (Magdalena Vieja)"
}, {ub: "150122", nom: "Miraflores"}, {ub: "150123", nom: "Pachacamac"}, {ub: "150124", nom: "Pucusana"}, {
    ub: "150125",
    nom: "Puente Piedra"
}, {ub: "150126", nom: "Punta Hermosa"}, {ub: "150127", nom: "Punta Negra"}, {
    ub: "150128",
    nom: "Rimac"
}, {ub: "150129", nom: "San Bartolo"}, {ub: "150130", nom: "San Borja"}, {
    ub: "150131",
    nom: "San Isidro"
}, {ub: "150132", nom: "San Juan de Lurigancho"}, {ub: "150133", nom: "San Juan de Miraflores"}, {
    ub: "150134",
    nom: "San Luis"
}, {ub: "150135", nom: "San Martin de Porres"}, {ub: "150136", nom: "San Miguel"}, {
    ub: "150137",
    nom: "Santa Anita"
}, {ub: "150138", nom: "Santa Maria del Mar"}, {ub: "150139", nom: "Santa Rosa"}, {
    ub: "150140",
    nom: "Santiago de Surco"
}, {ub: "150141", nom: "Surquillo"}, {ub: "150142", nom: "Villa El Salvador"}, {
    ub: "150143",
    nom: "Villa Maria del Triunfo"
}];
const regexMail = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
const banks = [
    {id: 1, nombre: "Banco de Comercio"}, {id: 2, nombre: "Banco de Crédito del Perú(BCP)"}, {
        id: 3,
        nombre: "Banco Interamericano de Finanzas (BanBif)"
    }, {id: 4, nombre: "Banco Pichincha"}, {id: 5, nombre: "BBVA Continental"}, {
        id: 6,
        nombre: "Citibank Perú"
    }, {id: 7, nombre: "Interbank"}, {id: 8, nombre: "Mi Banco"}, {id: 9, nombre: "Scotiabank Perú"}, {
        id: 10,
        nombre: "Banco GNB Perú"
    }, {id: 11, nombre: "Banco Falabella"}, {id: 12, nombre: "Banco Ripley"}, {
        id: 13,
        nombre: "Banco Santander Perú"
    }, {id: 14, nombre: "Banco Azteca"}, {id: 15, nombre: "Banco Cencosud"}, {id: 16, nombre: "ICBC PERU BANK"}];
const _tpdocs = [
...
function reqSuccess(r, timeout, withoutEscape) {
    ...
    if (isNaN(r.res)) {
        ...
        notificacionesSegunResponseCode(r.res);
    }
}
...
function exception(xhr, errorName) {
    ...
    if (sCode === 405) {
        ...
        $.smallBox({
            content: "Request method 'G|PT|PS|D' not supported or denied permissions",
            color: "alert",
            timeout: 10000
        });
        return;
    ...
    switch (code) {
        ...
        case -5:
            if (wildcard == undefined)
                $.smallBox({
                    color: "alert",
                    content: "<i> La validación ha fallado... Comuníquese con el administrador o intentelo nuevamente más tarde.</i>"
                });
            else//wildcard == validation errors
                $.smallBox({
                    color: "alert", content: `Datos enviados inválidos, total: ${wildcard.length}</br>
        ...
        case -6:
            $.smallBox({
                color: "alert",
                content: "<i> La validación ha fallado, respuesta vacía... Comuníquese con el administrador o intentelo nuevamente más tarde.</i>"
            });
            break;
        case -7:
            $.smallBox({
                color: "alert",
                content: "<i> La sessión interna ha fallado... Comuníquese con el administrador o intentelo nuevamente más tarde.</i>"
            });
            break;
        case -10:
            $.smallBox({
                color: "alert",
                content: "<i> La operación ha fallado... Comuníquese con el administrador o intentelo nuevamente más tarde.</i>"
            });
            break;
        case -11:
            $.smallBox({
        ...
        case -12:
            $.smallBox({
                color: "alert",
                content: "<i> No se ha encontrado coincidencias con los datos enviados... Comuníquese con el administrador o intentelo nuevamente más tarde.</i>"
            });
            break;
        case -99:
            $.smallBox({
...
function notificacionesSegunResponseCode(resCode, wildcard) {
    const code = Number(resCode);
    switch (code) {
        case -1:
        case -2:
...
function calcularEdadByFechaNacimiento(fechaNac) {
    ...
    if (actual.getMonth() > atleta.getMonth()) {
        ...
        if (actual.getDate() >= atleta.getDate()) {
        } else {
            --edad;
        }
    } else {
...
function roundedPercentage(l, target) {
    let off = target - _.reduce(l, function (acc, x) {
...
function showPasswordFichas(input) {
    const parent = input.parentElement;
    const fishEyeShow = parent.querySelector('#FishEyeShow');
    const fishEyeHide = parent.querySelector('#FishEyeHide');
    const inputPass = parent.querySelector('#Password');
    const type = inputPass.type;
    if (type == "password") {
        inputPass.type = "text"
        $(fishEyeHide).show(200)
        $(fishEyeShow).hide(200)
    } else {
        inputPass.type = "password"
        $(fishEyeHide).hide(200)
        $(fishEyeShow).show(200)
    }
}