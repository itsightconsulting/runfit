class Rutina {
    ...
    init(semana, semanaIx) {
        this.semanas[semanaIx] = new Semana(semana);
        this.completarFechasSemanas(true, semanaIx);
        this.mostrarVistaDia(this.semanas[semanaIx], semanaIx);
    }
...
class Semana{
    constructor(obj, fechaInicio, fechaFin){
        if(obj != undefined){
            ...
            this.metricas = obj.metricas ? obj.metricas != "" ? JSON.parse(obj.metricas) : "" : "";
            this.metricasVelocidad = obj.metricasVelocidad ? obj.metricasVelocidad != "" ? JSON.parse(obj.metricasVelocidad) : "" : "";
            this.kilometrajeTotal = obj.kilometrajeTotal;
            this.objetivos = obj.objetivos;
            this.flagEnvioCliente = obj.flagEnvioCliente;
            this.prioridad = obj.prioridad ? obj.prioridad : "";
        } else{
...
RutinaDiaHTML = (function(){
    return {
        basemn: (dia, diaIndex) => {
            ...
            const elementos = dia.elementos;
            const val = dia.elementos.length > 0 ? undefined : 'showInputsInit';//La validacion requiere un null;
            const mes = dia.fecha.getMonth() + 1;
            const prioridadNumber = $rutina.semanas[$gSemanaIx].prioridad.split(",")[diaIndex];
            return `<div class="panel panel-default">
        ...
        setElementos: (elementos, diaIndex, init, flagDescanso) => {
            return elementos.map((elemento, ix) =>
                `<div class="panel panel-default">
                          ...
                          <div class="panel-collapse collapse" id="elemento-${ix+''+diaIndex}">
