package com.itsight.support;

import com.itsight.util.StringUtil;
...
//        SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/yyyy");
    ...
    public String filterIn(String sqlFilter, @SuppressWarnings("rawtypes") Collection paramsList, String enclosing) {
