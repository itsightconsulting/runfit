...
public class Enums {
    ...
    public enum CfsCliente{
        CONTROL_REP_VIDEO, FAV_RUTINA_ID, FAV_TRAINER_ID,FAVS_POST_TRAINER, CONTROL_ENTRENAMIENTO, NOTIFICACION_CHAT
    }

    public enum Galletas{
        GLL_NOMBRE_COMPLETO, GLL_IMG_PERFIL, GLL_CONTROL_ENTRENAMIENTO, GLL_CONTROL_REP_VIDEO, GLL_FAV_RUTINA, GLL_NOTIFICACION_CHAT
    }
}
