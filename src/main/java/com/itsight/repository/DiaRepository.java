...
public interface DiaRepository extends JpaRepository<Dia, Long> {
    ...
    void updateEspecificaColumnaJsonBGenericoByQueryTextAndIdInt(@Param("id") Long id, @Param("valor") String valor, @Param(value = "texto") String texto);
    ...
    void updateTiemposDia(@Param("id") Long id, @Param("valor") String valor, @Param(value = "texto") String texto,@Param(value = "minutos") int totalMinutos);
    ...
    void updateDiaAndElemento(@Param("id") Long id, @Param(value = "calorias") double calorias, @Param(value = "totalDistancia") double totalDistancia, @Param(value = "txtNombre") String txtNombre, @Param("nombre") String nombre, @Param(value = "txtDistancia") String txtDistancia, @Param("distancia") String distancia);
    ...
    void saveElemento(@Param("id") Long id, @Param("lista") String lista);
    ...
    void updateDiaFromTemplate(@Param("id") Long id, @Param("calorias") double calorias, @Param("distancia") double distancia, @Param("minutos") int minutos,@Param("elementos") String elementos);
    ...
    void updateDiaRootFromTemplate(@Param("id") Long id, @Param("calorias") double calorias, @Param("distancia") double distancia, @Param("minutos") int minutos,@Param("elementos") String elementos);
    ...
    void deleteElementoById(Long id, int listaIndice, int minutos, double distancia, double calorias);
    ...
    void saveSubElemento(@Param("id") Long id, @Param("texto") String texto, @Param("elemento") String elemento);
    ...
    void saveElementoPosEspecificaGeneric(Long id, String texto, boolean insertarDespues, String elemento);
    ...
    void deleteSubElementoById(Long id, String texto, double distancia, double calorias);
    ...
    void updateAllJsonBGenericoByQueryTextAndId(@Param("id") Long id, @Param("elemento") String elemento, @Param(value = "texto") String texto);
    ...
    void updateEspecificasColumnasJsonBGenericoByQueriesTextAndId(Long id, String textoNombre, String nombre, String textoMedia, String media, String textoTipo, String tipo);
    ...
    void updateEspecificasColumnasJsonBGenericoByQueriesTextAndId2(Long id, String textoNombre, String nombre, String textoMedia, String entryMedia);
    ...
    void updateSubElementos(@Param("id") Long id, @Param("texto") String texto, @Param("subEles") String subEles);
    ...
    void updateDiaAndSubEleEle(@Param("id") Long id, @Param("calorias") double calorias, @Param("totalDistancia") double totalDistancia, @Param("txtDistancia") String txtDistancia, @Param("distancia") String distancia, @Param("txtNewSubEle") String txtNewSubEle, @Param("subEle") String subEle);
