...
public interface PorcentajesKilometrajeRepository extends JpaRepository<PorcentajesKilometraje, Integer> {
    ...
    void updatePorcentajesComplex(int trainerId, int distancia, String textNombre1, String porcentajes, String textNombre2, String porcentajes1, String textNombre3, String porcentajes2);
}
