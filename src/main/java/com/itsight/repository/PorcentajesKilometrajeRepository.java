...
public interface PorcentajesKilometrajeRepository extends JpaRepository<PorcentajesKilometraje, Integer> {
    ...
    List<PorcentajesKilometraje> findAllByTrainerId(Long trainerId);
    ...
    void updatePorcentajesComplex(Long trainerId, int distancia, String textNombre1, String porcentajes, String textNombre2, String porcentajes1, String textNombre3, String porcentajes2);
}
