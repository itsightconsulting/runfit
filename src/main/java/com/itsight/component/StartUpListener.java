...
import static com.itsight.util.Enums.TipoUsuario.*;
...
public class StartUpListener implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void insertASubCategoriaEjercicio() {
        if (subCategoriaEjercicioService.findOne(1) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Velocidad", 1, true));
        if (subCategoriaEjercicioService.findOne(2) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Resistencia especial", 1, true));
        if (subCategoriaEjercicioService.findOne(3) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Pre competitivos", 1, true));
        if (subCategoriaEjercicioService.findOne(4) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Spinning", 1, true));
        if (subCategoriaEjercicioService.findOne(5) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Fuerza", 2, true));
        if (subCategoriaEjercicioService.findOne(6) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Resistencia a la fuerza", 2, true));
        if (subCategoriaEjercicioService.findOne(7) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Potencia", 2, true));
        if (subCategoriaEjercicioService.findOne(8) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Estándar", 3, true));
        if (subCategoriaEjercicioService.findOne(9) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Spinning", 3, true));
        if (subCategoriaEjercicioService.findOne(10) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Gluteos", 4, true));
        if (subCategoriaEjercicioService.findOne(11) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Abductores", 4, true));
        if (subCategoriaEjercicioService.findOne(12) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Aductores", 4, true));
        if (subCategoriaEjercicioService.findOne(13) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Banda iliotibial", 4, true));
        if (subCategoriaEjercicioService.findOne(14) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Pantorrillas", 4, true));
        if (subCategoriaEjercicioService.findOne(15) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Sóleo y tendón de Aquiles", 4, true));
        if (subCategoriaEjercicioService.findOne(16) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Recto y Psoas", 4, true));
        if (subCategoriaEjercicioService.findOne(17) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Extensores de la espalda a la fuerza", 4, true));
        if (subCategoriaEjercicioService.findOne(18) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Estándar", 4, true));
        if (subCategoriaEjercicioService.findOne(19) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Isquiotibiales", 4, true));
        if (subCategoriaEjercicioService.findOne(20) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Cuádriceps", 4, true));
        if (subCategoriaEjercicioService.findOne(21) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Estándar", 5, true));
        if (subCategoriaEjercicioService.findOne(21) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Básicos", 6, true));
        if (subCategoriaEjercicioService.findOne(22) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Intermedios", 6, true));
        if (subCategoriaEjercicioService.findOne(23) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Avanzados", 6, true));
        if (subCategoriaEjercicioService.findOne(24) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Pre-competitivo", 6, true));
        if (subCategoriaEjercicioService.findOne(25) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("En el sitio", 6, true));
        if (subCategoriaEjercicioService.findOne(26) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Integeritud de paso", 7, true));
        if (subCategoriaEjercicioService.findOne(27) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Cadencia", 7, true));
        if (subCategoriaEjercicioService.findOne(28) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Centro de gravedad", 7, true));
        if (subCategoriaEjercicioService.findOne(29) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Pisada", 7, true));
        if (subCategoriaEjercicioService.findOne(30) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Zancada", 7, true));
        if (subCategoriaEjercicioService.findOne(31) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Braceo", 7, true));
        if (subCategoriaEjercicioService.findOne(32) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Coordinativos", 7, true));
        if (subCategoriaEjercicioService.findOne(33) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Potencia", 7, true));
        if (subCategoriaEjercicioService.findOne(34) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Fuerza", 7, true));
        if (subCategoriaEjercicioService.findOne(35) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Posturales", 7, true));
        if (subCategoriaEjercicioService.findOne(36) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Básicos", 7, true));
        if (subCategoriaEjercicioService.findOne(37) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Spinning", 8, true));
        if (subCategoriaEjercicioService.findOne(38) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Post maratón", 8, true));
        if (subCategoriaEjercicioService.findOne(39) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Fortalecimiento de tobillo", 8, true));
        if (subCategoriaEjercicioService.findOne(40) == null)
            subCategoriaEjercicioService.save(new SubCategoriaEjercicio("Propioceptivas", 8, true));
    }
    ...
    public void insertAEspecificacionSubCategoriaEjercicio() {
        ...
        for (SubCategoriaEjercicio sce : subCategoriaEjercicioService.findAllByOrderById()) {
            if (lstFlexSubCatIds.contains(sce.getId())) {
                if (especificacionSubCategoriaService.findOne(index++) == null)
                    especificacionSubCategoriaService.save(new EspecificacionSubCategoria("General", sce.getId(), 1, true));
            } else {
                for (int i = 1; i < 4; i++) {
                    if (especificacionSubCategoriaService.findOne(index++) == null)
                        especificacionSubCategoriaService.save(new EspecificacionSubCategoria("Acondicionamiento", sce.getId(), i, true));
                    if (especificacionSubCategoriaService.findOne(index++) == null)
                        especificacionSubCategoriaService.save(new EspecificacionSubCategoria("General", sce.getId(), i, true));
                    if (especificacionSubCategoriaService.findOne(index++) == null)
                        especificacionSubCategoriaService.save(new EspecificacionSubCategoria("Específica", sce.getId(), i, true));
                    if (especificacionSubCategoriaService.findOne(index++) == null)
                        especificacionSubCategoriaService.save(new EspecificacionSubCategoria("Precompetitiva", sce.getId(), i, true));
                    if (especificacionSubCategoriaService.findOne(index++) == null)
                        especificacionSubCategoriaService.save(new EspecificacionSubCategoria("Competitiva", sce.getId(), i, true));
                }
            }
        }
    }
    ...
    public void insertAGrupoVideo() {
        ...
        if (grupoVideoService.findOne(1) == null) grupoVideoService.save(
                new GrupoVideo("Fuerza tren inferior", 2, true, "87e1bccc-5d86-4db0-a59a-0610553868a1.png", UUID.fromString("87e1bccc-5d86-4db0-a59a-0610553868a1"), ".png"));
        if (grupoVideoService.findOne(2) == null) grupoVideoService.save(
                new GrupoVideo("Fuerza tren superior", 2, true, "3110f934-4bdf-4b3a-a207-d5334ce31a5d.png", UUID.fromString("3110f934-4bdf-4b3a-a207-d5334ce31a5d"), ".png"));
        if (grupoVideoService.findOne(3) == null) grupoVideoService.save(
                new GrupoVideo("Técnicos", 2, true, "ce5a818d-3032-4286-8b25-7bfe0dbde8be.png", UUID.fromString("ce5a818d-3032-4286-8b25-7bfe0dbde8be"), ".png"));
        if (grupoVideoService.findOne(4) == null) grupoVideoService.save(
                new GrupoVideo("Flexibilidad - Movilidad - Masajes", 2, true, "e22d1f51-b10d-4e9e-bd6b-fa85eefe8c6f.png", UUID.fromString("e22d1f51-b10d-4e9e-bd6b-fa85eefe8c6f"), ".png"));
        if (grupoVideoService.findOne(5) == null) grupoVideoService.save(
                new GrupoVideo("Propioceptivos", 2, true, "741081a8-0156-4c20-8117-91c086188ef7.png", UUID.fromString("741081a8-0156-4c20-8117-91c086188ef7"), ".png"));
    }

    public void insertACategoriaVideo() {
        if (categoriaVideoService.findOne(1) == null)
            categoriaVideoService.save(new CategoriaVideo("Cuádriceps", 1, true));
        if (categoriaVideoService.findOne(2) == null)
            categoriaVideoService.save(new CategoriaVideo("Glúteos", 1, true));
        if (categoriaVideoService.findOne(3) == null)
            categoriaVideoService.save(new CategoriaVideo("Isquiotibiales", 1, true));
        if (categoriaVideoService.findOne(4) == null)
            categoriaVideoService.save(new CategoriaVideo("Flexóres de la cadera", 1, true));
        if (categoriaVideoService.findOne(5) == null)
            categoriaVideoService.save(new CategoriaVideo("Pliométricos", 1, true));
        if (categoriaVideoService.findOne(6) == null)
            categoriaVideoService.save(new CategoriaVideo("Tríceps sural", 1, true));
        if (categoriaVideoService.findOne(7) == null)
            categoriaVideoService.save(new CategoriaVideo("Tibiales", 1, true));
        if (categoriaVideoService.findOne(8) == null)
            categoriaVideoService.save(new CategoriaVideo("Tobillos", 1, true));
        if (categoriaVideoService.findOne(9) == null)
            categoriaVideoService.save(new CategoriaVideo("Plantares", 1, true));
        if (categoriaVideoService.findOne(10) == null)
            categoriaVideoService.save(new CategoriaVideo("Rotadores", 1, true));
        if (categoriaVideoService.findOne(11) == null)
            categoriaVideoService.save(new CategoriaVideo("Tensor y B. Iliotibial", 1, true));
        if (categoriaVideoService.findOne(12) == null)
            categoriaVideoService.save(new CategoriaVideo("Aductores", 1, true));

        if (categoriaVideoService.findOne(13) == null)
            categoriaVideoService.save(new CategoriaVideo("Cuello", 2, true));
        if (categoriaVideoService.findOne(14) == null)
            categoriaVideoService.save(new CategoriaVideo("Deltoides", 2, true));
        if (categoriaVideoService.findOne(15) == null)
            categoriaVideoService.save(new CategoriaVideo("Espalda", 2, true));
        if (categoriaVideoService.findOne(16) == null)
            categoriaVideoService.save(new CategoriaVideo("Pectorales", 2, true));
        if (categoriaVideoService.findOne(17) == null)
            categoriaVideoService.save(new CategoriaVideo("Flexores del codo", 2, true));
        if (categoriaVideoService.findOne(18) == null)
            categoriaVideoService.save(new CategoriaVideo("Tríceps", 2, true));
        if (categoriaVideoService.findOne(19) == null) categoriaVideoService.save(new CategoriaVideo("Core", 2, true));
        if (categoriaVideoService.findOne(20) == null)
            categoriaVideoService.save(new CategoriaVideo("Braceo", 2, true));
        if (categoriaVideoService.findOne(21) == null)
            categoriaVideoService.save(new CategoriaVideo("Globales", 2, true));

        if (categoriaVideoService.findOne(22) == null)
            categoriaVideoService.save(new CategoriaVideo("Zancada", 3, true));
        if (categoriaVideoService.findOne(23) == null)
            categoriaVideoService.save(new CategoriaVideo("Coordinativos", 3, true));
        if (categoriaVideoService.findOne(24) == null)
            categoriaVideoService.save(new CategoriaVideo("Trotes", 3, true));
        if (categoriaVideoService.findOne(25) == null)
            categoriaVideoService.save(new CategoriaVideo("Potencia", 3, true));
        if (categoriaVideoService.findOne(26) == null)
            categoriaVideoService.save(new CategoriaVideo("Postulares", 3, true));
        if (categoriaVideoService.findOne(27) == null)
            categoriaVideoService.save(new CategoriaVideo("Braceo", 3, true));
        if (categoriaVideoService.findOne(28) == null) categoriaVideoService.save(new CategoriaVideo("ABC", 3, true));
        if (categoriaVideoService.findOne(29) == null)
            categoriaVideoService.save(new CategoriaVideo("Piques", 3, true));

        if (categoriaVideoService.findOne(30) == null)
            categoriaVideoService.save(new CategoriaVideo("Brazos", 4, true));
        if (categoriaVideoService.findOne(31) == null)
            categoriaVideoService.save(new CategoriaVideo("Cadenas. M.", 4, true));
        if (categoriaVideoService.findOne(32) == null)
            categoriaVideoService.save(new CategoriaVideo("Caderas", 4, true));
        if (categoriaVideoService.findOne(33) == null)
            categoriaVideoService.save(new CategoriaVideo("Cervical", 4, true));
        if (categoriaVideoService.findOne(34) == null)
            categoriaVideoService.save(new CategoriaVideo("Dinámicos", 4, true));
        if (categoriaVideoService.findOne(35) == null)
            categoriaVideoService.save(new CategoriaVideo("Lumbar", 4, true));
        if (categoriaVideoService.findOne(36) == null)
            categoriaVideoService.save(new CategoriaVideo("Masajes", 4, true));
        if (categoriaVideoService.findOne(37) == null)
            categoriaVideoService.save(new CategoriaVideo("Movilidad", 4, true));
        if (categoriaVideoService.findOne(38) == null)
            categoriaVideoService.save(new CategoriaVideo("Rodilla", 4, true));
        if (categoriaVideoService.findOne(39) == null)
            categoriaVideoService.save(new CategoriaVideo("Tobillos", 4, true));

        if (categoriaVideoService.findOne(40) == null)
            categoriaVideoService.save(new CategoriaVideo("En pelotas", 5, true));
        if (categoriaVideoService.findOne(41) == null)
            categoriaVideoService.save(new CategoriaVideo("Miembros superiores", 5, true));
        if (categoriaVideoService.findOne(42) == null)
            categoriaVideoService.save(new CategoriaVideo("Clásicos", 5, true));
    }
    ...
    public void insertASubCategoriaVideo() {
        ...
        for (CategoriaVideo sce : categoriaVideoService.findAll()) {
            int i = sce.getId();
            if (subCategoriaVideoService.findOne(index++) == null)
                subCategoriaVideoService.save(new SubCategoriaVideo("Concéntricos", i, true));
            if (subCategoriaVideoService.findOne(index++) == null)
                subCategoriaVideoService.save(new SubCategoriaVideo("Excéntricos", i, true));
            if (subCategoriaVideoService.findOne(index++) == null)
                subCategoriaVideoService.save(new SubCategoriaVideo("Isométricos", i, true));
            if (subCategoriaVideoService.findOne(index++) == null)
                subCategoriaVideoService.save(new SubCategoriaVideo("Propiocepticos", i, true));
            if (subCategoriaVideoService.findOne(index++) == null)
                subCategoriaVideoService.save(new SubCategoriaVideo("Téc. concéntricos", i, true));
            if (subCategoriaVideoService.findOne(index++) == null)
                subCategoriaVideoService.save(new SubCategoriaVideo("Téc. Pliométricos", i, true));
        }
    }
    ...
    public void addingtipoCanalVentaToTable() {
        if (tipoCanalVentaService.findOne(1) == null)
            tipoCanalVentaService.save(new TipoCanalVenta("Por recomendación"));
    ...
    public void addingConfiguracionGeneralToTable() {
        if (configuracionGeneralService.findOne(2) == null)
            configuracionGeneralService.save(new ConfiguracionGeneral("CONTROL_REP_VIDEO", "REPETICION", true, CLIENTE.ordinal()));
        if (configuracionGeneralService.findOne(3) == null)
            configuracionGeneralService.save(new ConfiguracionGeneral("FAV_RUTINA_ID", "", true, CLIENTE.ordinal()));
        if (configuracionGeneralService.findOne(4) == null)
            configuracionGeneralService.save(new ConfiguracionGeneral("FAV_TRAINER_ID", "", true, CLIENTE.ordinal()));
        if (configuracionGeneralService.findOne(5) == null)
            configuracionGeneralService.save(new ConfiguracionGeneral("FAVS_POST_TRAINER", "", true, CLIENTE.ordinal()));
        if (configuracionGeneralService.findOne(6) == null)
            configuracionGeneralService.save(new ConfiguracionGeneral("CONTROL_ENTRENAMIENTO", "DIARIA", true, CLIENTE.ordinal()));
        if (configuracionGeneralService.findOne(7) == null)
            configuracionGeneralService.save(new ConfiguracionGeneral("NOTIFICACION_CHAT", "", true, CLIENTE.ordinal()));
        if (configuracionGeneralService.findOne(8) == null)
            configuracionGeneralService.save(new ConfiguracionGeneral("TOTAL_RUTINAS_ACTIVAS", "", true, CLIENTE.ordinal()));

    }

    public void addingKilometrajeBase() {
        if (kilometrajeBaseService.findOne(1) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 1, 1, 30.67));
        if (kilometrajeBaseService.findOne(2) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 1, 2, 41.14));
        if (kilometrajeBaseService.findOne(3) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 1, 3, 34.41));
        if (kilometrajeBaseService.findOne(4) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 1, 4, 11.22));

        if (kilometrajeBaseService.findOne(5) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 1, 1, 38.15));
        if (kilometrajeBaseService.findOne(6) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 1, 2, 52.36));
        if (kilometrajeBaseService.findOne(7) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 1, 3, 40.39));
        if (kilometrajeBaseService.findOne(8) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 1, 4, 22.44));

        if (kilometrajeBaseService.findOne(9) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 1, 1, 59.84));
        if (kilometrajeBaseService.findOne(10) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 1, 2, 101.00));
        if (kilometrajeBaseService.findOne(11) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 1, 3, 74.80));
        if (kilometrajeBaseService.findOne(12) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 1, 4, 29.92));

        if (kilometrajeBaseService.findOne(13) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 2, 1, 34.85));
        if (kilometrajeBaseService.findOne(14) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 2, 2, 46.75));
        if (kilometrajeBaseService.findOne(15) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 2, 3, 39.10));
        if (kilometrajeBaseService.findOne(16) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 2, 4, 12.75));

        if (kilometrajeBaseService.findOne(17) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 2, 1, 43.35));
        if (kilometrajeBaseService.findOne(18) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 2, 2, 59.50));
        if (kilometrajeBaseService.findOne(19) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 2, 3, 45.90));
        if (kilometrajeBaseService.findOne(20) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 2, 4, 25.50));

        if (kilometrajeBaseService.findOne(21) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 2, 1, 68.00));
        if (kilometrajeBaseService.findOne(22) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 2, 2, 114.80));
        if (kilometrajeBaseService.findOne(23) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 2, 3, 85.00));
        if (kilometrajeBaseService.findOne(24) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 2, 4, 34.00));

        if (kilometrajeBaseService.findOne(25) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 3, 1, 41.00));
        if (kilometrajeBaseService.findOne(26) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 3, 2, 55.00));
        if (kilometrajeBaseService.findOne(27) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 3, 3, 46.00));
        if (kilometrajeBaseService.findOne(28) == null)
            kilometrajeBaseService.save(new KilometrajeBase(10, 3, 4, 15.00));

        if (kilometrajeBaseService.findOne(29) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 3, 1, 51.00));
        if (kilometrajeBaseService.findOne(30) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 3, 2, 70.00));
        if (kilometrajeBaseService.findOne(31) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 3, 3, 54.00));
        if (kilometrajeBaseService.findOne(32) == null)
            kilometrajeBaseService.save(new KilometrajeBase(21, 3, 4, 30.00));

        if (kilometrajeBaseService.findOne(33) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 3, 1, 80.00));
        if (kilometrajeBaseService.findOne(34) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 3, 2, 135.00));
        if (kilometrajeBaseService.findOne(35) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 3, 3, 100.00));
        if (kilometrajeBaseService.findOne(36) == null)
            kilometrajeBaseService.save(new KilometrajeBase(42, 3, 4, 40.00));
    }
    ...
    public void addingPaises() {
        ...
        if (paisService.findOne(535) == null)
            paisService.save(new Pais(535, "Bonaire, San Eustaquio y Saba", "BQ", "BES"));
        ...
        if (paisService.findOne(239) == null)
            paisService.save(new Pais(239, "Islas Georgias del Sur y Sandwich del Sur", "GS", "SGS"));
        ...
        if (paisService.findOne(581) == null)
            paisService.save(new Pais(581, "Islas ultramarinas de Estados Unidos", "UM", "UMI"));
        if (paisService.findOne(92) == null) paisService.save(new Pais(92, "Islas Vírgenes Británicas", "VG", "VGB"));
        if (paisService.findOne(850) == null)
            paisService.save(new Pais(850, "Islas Vírgenes de los Estados Unidos", "VI", "VIR"));
        ...
        if (paisService.findOne(732) == null)
            paisService.save(new Pais(732, "República Árabe Saharaui Democrática", "EH", "ESH"));
        ...
        if (paisService.findOne(180) == null)
            paisService.save(new Pais(180, "República Democrática del Congo", "CD", "COD"));
        ...
        if (paisService.findOne(670) == null)
            paisService.save(new Pais(670, "San Vicente y las Granadinas", "VC", "VCT"));
        if (paisService.findOne(654) == null)
            paisService.save(new Pais(654, "Santa Elena, Ascensión y Tristán de Acuña", "SH", "SHN"));
        ...
        if (paisService.findOne(158) == null)
            paisService.save(new Pais(158, "Taiwán (República de China)", "TW", "TWN"));
        ...
        if (paisService.findOne(86) == null)
            paisService.save(new Pais(86, "Territorio Británico del Océano Índico", "IO", "IOT"));
        if (paisService.findOne(260) == null)
            paisService.save(new Pais(260, "Tierras Australes y Antárticas Francesas", "TF", "ATF"));
    ...
    public void addingModulo() {
        try {
            ...
            for (int i = 1; i < lines.length; i++) {
                String[] line = lines[i].split(",");
                if (moduloService.findOneByNombre(line[0].trim()) == null)
                    moduloService.save(new Modulo(line[0].trim(), line[1].trim()));
            }
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    ...
    public void addingCorreo() {
        try {
            ...
            for (int i = 1; i < lines.length; i++) {
                String[] line = lines[i].split("\\|");
                if (correoService.findOne(i) == null) correoService.save(
                        new Correo(
                                line[0].trim(),
                                line[1].trim(),
    ...
    public void addingVideo() {
        try {
            ...
            for (int i = 1; i < lines.length; i++) {
                String[] line = lines[i].split(",");
                if (videoService.findOne(index++) == null) videoService.save(
                        new Video(
                                line[0].trim(),
                                line[1].trim(),
                                line[2].trim(),
                                line[3].trim(),
                                UUID.fromString(line[4].trim()),
                                null,
                                Integer.parseInt(line[5].trim()),
                                Integer.parseInt(line[6].trim()),
                                Boolean.valueOf(line[7].trim())));
            }
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    ...
    public void addingIdioma() {
        try {
            ...
            for (int i = 1; i < lines.length; i++) {
                String[] line = lines[i].split(",");
                if (idiomaRepository.findById(i).orElse(null) == null)
                    idiomaRepository.save(new Idioma(line[0].trim(), line[1].trim()));
            }
        } catch (IOException ex) {
            ex.printStackTrace();
        }
