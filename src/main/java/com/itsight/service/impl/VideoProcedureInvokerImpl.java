...
public class VideoProcedureInvokerImpl implements VideoProcedureInvoker {
    ...
    public List<VideoPOJO> findAllByDynamic(VideoQueryDTO query) {
        ...
        storedProcedureQuery.setParameter(3, query.getGrupoVideoId());
        storedProcedureQuery.setParameter(4, query.getFlag());
        storedProcedureQuery.setParameter(5, query.getLimit());
        storedProcedureQuery.setParameter(6, query.getOffset());
